...
import com.example.worldskillsproject.databinding.ActivityMapaBinding
...
class MapaActivity : AppCompatActivity() {
    ...
    private val binding by lazy {
        ActivityMapaBinding.inflate(layoutInflater)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("mapa")) {
            val mapa = intent.getStringExtra("mapa")
            Glide.with(this)
                .load(mapa)
                .into(binding.imageMapa)
        }
